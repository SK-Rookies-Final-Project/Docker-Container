...
cat > jdbc-mysql-source.json << 'EOF'
{
    ...
    "config": {
        ...
        "key.converter.schema.registry.url": "http://18.220.17.107:8081,http://18.220.17.107:8082",
        "value.converter": "io.confluent.connect.avro.AvroConverter",
        "value.converter.schema.registry.url": "http://18.220.17.107:8081,http://18.220.17.107:8082",
