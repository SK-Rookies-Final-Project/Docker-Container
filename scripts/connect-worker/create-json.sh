...
cat > jdbc-mysql-source.json << 'EOF'
{
    ...
    "config": {
        ...
        "key.converter.schema.registry.url": "http://localhost:18081,http://localhost:18082",
        "value.converter": "io.confluent.connect.avro.AvroConverter",
        "value.converter.schema.registry.url": "http://localhost:18081,http://localhost:18082",
